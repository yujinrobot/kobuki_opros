...
class ServoActuator : public OprosDevice
{
public:
	ServoActuator(void)		{	}
...
public:
	virtual int32_t SetVelocity(OPRoS::Float64 velocity)	{ return API_NOT_SUPPORTED; }
	virtual int32_t GetVelocity(OPRoS::Float64 &velocity)						{ return API_NOT_SUPPORTED; }
	virtual int32_t SetPosition(OPRoS::Float64 position, OPRoS::UInt32 time)	{ return API_NOT_SUPPORTED; }
	virtual int32_t GetPosition(OPRoS::Float64 &position)						{ return API_NOT_SUPPORTED; }
};
